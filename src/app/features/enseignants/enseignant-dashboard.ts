// ============================================
// enseignant-details.component.ts
// ============================================
            ...
            <div class="info-section">
              ...
              <div class="quick-stats">
                ...
                <div class="stat">
                  ...
                  <span>{{getTotalTalibes()}} talibés</span>
                </div>
              ...
              <div class="action-buttons">
                ...
                <button mat-raised-button color="accent" (click)="assignerCours()">
